			...
			<header class="post-header">
				...
				<ul class="meta single-meta clr">
					<?php if ( get_theme_mod( 'wpex_post_date', true ) ) : ?>
						<li><span class="fa fa-clock-o"></span><?php the_time('h:i'); ?></li>
					<?php endif; ?>
					<?php if ( get_theme_mod( 'wpex_post_category', true ) ) : ?>
						<li><span class="fa fa-map-marker"></span><a target="_blank" href="http://localhost:8888/cumulus/schools/"><?php foreach((get_the_category()) as $category) { echo $category->cat_name . ' '; } ?> </a></li>
					<?php endif; ?>
